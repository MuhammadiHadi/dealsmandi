...
class MainModel extends Model
{
    ...
    public function subCategory($id){
        $db = \Config\Database::connect();
        $query = $db->query("SELECT * FROM subcategorys where category_id= $id");
        return $query->getResult();
    }

    public function subChildCatetory($id){
        $db = \Config\Database::connect();
        $query = $db->query("SELECT * FROM subcatogriesthrees where subcategory_id= $id");
        return $query->getResult();
    }

    public function singleSubChildCategory($id){
        $db = \Config\Database::connect();
        $query = $db->query("SELECT * FROM subcatogriesthrees where id= $id");
        return $query->getRow();
    }
    public function singleSubCategory($id){
        $db = \Config\Database::connect();
        $query = $db->query("SELECT * FROM subcategorys where id= $id");
        return $query->getRow();
    }
...
*/
    public function list_4_all_cats($cat)
    {
        ...
        //$ids = "('1','2','3','4')";
        $q = "SELECT * FROM categories WHERE id IN (" . $cat . ")";
        $query = $db->query($q);

        //$query=$db->query("SELECT * FROM categories where id IN ('$ids')");
        return $query->getResult();
    }
...
// get next id ( ad_id is unique id)
    ...
    *************************************** */
    public function get_next_id()
    {
        ...
        $query = $db->query("SELECT max(id) as max_id
                                 FROM advertisements")->getRow();
        $max_id = $query->max_id;
    ...
    *************************************** */
    public function get_id_pk($ad_id)
    {
        ...
        $query = $db->query("SELECT id
                                 FROM advertisements where id= '$ad_id'")->getRow();
        $id = $query->id;
...
// get next id ( ad_id is unique id)
    ...
    *************************************** */
    public function get_main_cat_name($id)
    {
        ...
        $query = $db->query("SELECT category_name FROM categories WHERE id='$id'")->getRow();
        $main_cat_name = $query->category_name;
    ...
    public function list_featured_ads()
    {
        ...
        /*        $query=$db->query("SELECT ae.id, ae.cat, ae.sub_cat, ae.title, ae.ad_description, ae.price, ae.users, au.name, ae.city, ae.neighbourhood, ae.phone_no
  FROM ad_entry ae, users au 
WHERE ae.users = au.id
and ae.ad_STATUS=1
"); 
-----------
SELECT ae.id, ae.cat_id, ae.sub_cat_id, ae.title, ae.description, ae.price, ae.user_id, ci.city_name, nh.neighbourhoods_title, ae.phone_number, ae.STATUS FROM advertisements ae, neighbourhoods nh, cities ci where ae.neighbourhood_Id = nh.id and ae.cityId = ci.id and ae.id =25;
*/
        $query = $db->query("SELECT ae.id, ae.cat_id, ae.sub_cat_id, ae.title, ae.description, ae.price, ae.user_id, ci.city_name as city, nh.neighbourhoods_title as neighbourhood, ae.phone_number, ae.STATUS FROM advertisements ae, neighbourhoods nh, cities ci where ae.neighbourhood_Id = nh.id and ae.cityid=ci.id");
    ...
    public function list_related_ads()
    {
        ...
        $query = $db->query("SELECT ae.id, ae.cat_id, ae.sub_cat_id, ae.title, ae.description, ae.price, au.name, ci.city_name as city, nh.neighbourhoods_title as neighbourhood, ae.phone_number
  FROM advertisements ae, users au, neighbourhoods nh, cities ci where ae.neighbourhood_Id = nh.id and ae.cityid=ci.id");
        return $query->getResult();
    }
    ...
    public function single($id)
    {
        ...
        $db = \Config\Database::connect();
        /* -------
SELECT ae.id, ae.cat_id, ae.sub_cat_id, ae.title, ae.description, ae.price, ae.user_id, ci.city_name as city, nh.neighbourhoods_title as neighbourhood, ae.phone_number, ae.STATUS FROM advertisements ae, neighbourhoods nh, cities ci where ae.neighbourhood_Id = nh.id and ae.cityid=ci.id
------- */
        $query = $db->query("SELECT * FROM ads_v WHERE id = '$id'");
        //return $query->getResult();
        return $query->getRow();
    }
    ...
    public function total_ads($cat)
    {
        ...
        if (isset($cat)) {
            $query_main_cat  = $db->query("SELECT count(id) as main_cat FROM categories WHERE NAME = '$cat'");
