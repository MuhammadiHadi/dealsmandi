		...
		<section class="container">
			...
			<section class="container">
				<section class="row">
					...
					<!-- <div class="col-3 col-sm-4 wow animated fadeIn" data-wow-delay=="0.3s"> -->
...
<?php
				    ...
				    <div class="col-3 col-sm-4">
						...
						<h2><?php  echo $fetch['school_name'];  ?></h2>
						<a href="https://<?php echo $fetch['subdomain']; ?>.keepschoolin.com"><h2><?php  echo $fetch['school_name'];  ?></h2></a>
						
						<p class="wow animated fadeIn" data-wow-delay=="0.7s"><?php  echo $fetch['school_name'];  ?></p>
